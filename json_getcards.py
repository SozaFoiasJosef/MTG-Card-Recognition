...
normal_images = [item["image_uris"]["art_crop"] for item in filtered_data if "image_uris" in item and "art_crop" in item["image_uris"]]
...
with open("mh2set_artcrop.json", "w") as f:
